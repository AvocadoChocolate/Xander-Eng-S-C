...
local speech = {"Great.", "Fantastic.", "Excellent."}
local dialog = {}
local speechtext = {}
...
function scene:show( event )
    ...
    local speechtext = display.newText( "Can you find the\nshape that fits?", speech.x, speech.y,speech.contentWidth/1.3,0,teachersPetFont,20 )
