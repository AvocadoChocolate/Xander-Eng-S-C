...
local t1 = {text="square",image="vierkant.png",sound="vwortel.mp3"}
local t2 = {text="triangle",image="driehoek.png",sound="vboontjie.mp3"}
local t3 = {text="heart",image="hart.png",sound="vkomkommer.mp3"}
local t4 = {text="circle",image="sirkel.png",sound="vuie.mp3"}
local t6 = {text="star",image="ster.png",sound="vsoetrisse.mp3"}
local t5 = {text="rectangle",image="reghoek.png",sound="vspinasie.mp3"}
