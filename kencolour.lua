...
local t1 = {text="blue",image="blou.png",sound="vwortel.mp3"}
local t2 = {text="orange",image="oranje.png",sound="vboontjie.mp3"}
local t3 = {text="red",image="rooi.png",sound="vkomkommer.mp3"}
local t4 = {text="yellow",image="geel.png",sound="vuie.mp3"}
local t6 = {text="green",image="groen.png",sound="vsoetrisse.mp3"}
local t5 = {text="purple",image="pers.png",sound="vspinasie.mp3"}
